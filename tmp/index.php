...
session_start();
/*Создаем провайдера CLIENT_ID в файле crm_base.php*/
$provider = new AmoCRM([
    'clientId' => CLIENT_ID,
...
if (!isset($_GET['request'])) {
    ...
    try {
         ...
         * Делаем запрос к АПИ
         */
        $data = $provider->getHttpClient()->request('GET', $provider->urlAccount() . 'api/v2/account', [
...
require_once('crm_control_class.php');
